...
STAGES = [
    ...
    Stage("llm_pilot", "creoh_llm_pilot", "Claude proposer pilot"),
    Stage("ollama_pilot", "creoh_ollama_pilot", "Qwen-7B proposer pilot (offline replay)"),
    Stage("qwen27_pilot", "creoh_qwen27_pilot", "Qwen-27B proposer pilot (offline replay)"),
