# Selective reserve, aggressive setting. The reserve is applied only to the work orders
...
# aggressiveness parameter tau places this member near the risk-averse end of the
# cost-risk frontier.
import math
...
def solve(instance, params):
    return _solve_with(instance, 0.10)
