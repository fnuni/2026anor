# Selective reserve, mild setting. The reserve is applied only to the work orders
...
# aggressiveness parameter tau places this member near the low-cost end of the
# cost-risk frontier.
import math
...
def solve(instance, params):
    return _solve_with(instance, 0.75)
